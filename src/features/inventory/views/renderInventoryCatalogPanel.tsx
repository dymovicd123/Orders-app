                ...
                <section className="catalog-detail-editor catalog-variant-editor-v2 w6-variant-editor">
                  <div className="catalog-detail-editor-head">
                    <div>
                      ...
                      <p>{catalogVariantDraft.id ? 'Старой унисекс-позиции без пола можно выбрать ЖЕН или МУЖ даже при наличии истории: если такой же конкретной комбинации ещё нет, система сохранит тот же SKU и текущий остаток. Для остальных полей действует прежняя защита: если комбинация уже использовалась, сервер не позволит её переписать.' : 'Техническое значение «СТАНДАРТ» допустимо в данных; в обычном просмотре оно показывается как «Основное исполнение».'}</p>
                    </div>
                    <button className="secondary compact" type="button" onClick={closeEditor}>Закрыть</button>
                  </div>
