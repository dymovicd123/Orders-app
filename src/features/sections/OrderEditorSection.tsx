                ...
                <>
                  ...
                  <div className="editor-columns">
                    ...
                    <section className="mini-panel">
                      ...
                      <p className="mini-panel-note">
                        Проведённые оплаты редактируются прямо в полях ниже: дата, сумма, способ, смысл и комментарий сохраняются вместе с заказом, ID оплаты не меняется. Если первичную оплату забыли внести, при создании она относится к дате заказа. Для доплаты, связанной с обменом, здесь доступен только способ оплаты; остальные поля исправляются через операцию обмена.
                      </p>
                      <div className="stack">
