...
assert.ok(completion.indexOf('await markOrderSentToClient(freshResult.order)') < completion.indexOf('setOrderCatalogResolutionOrder(null)'), 'R9.2A: resolver must stay open until shipping succeeds')
