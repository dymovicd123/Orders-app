...
check(polish.includes('data-variant-id={variant.id}') && polish.includes('openVariantCard(variant, group, colorGroup, subgroup)'), 'exact variant identity/action path was lost during grouping')
...
console.log('W6.3 CATALOG POLISH PASSED — execution/color/size scanning, honest filtering, exact variant action hierarchy and future pricing anchors are protected')
