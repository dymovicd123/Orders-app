...
const stage02Phase2BWorkerManifest = JSON.parse(fs.readFileSync(path.join(root, 'scripts/stage02-phase2b-shipping-possession-worker-manifest.json'), 'utf8'))
if (stage02Phase2BWorkerManifest?.version !== 1 || stage02Phase2BWorkerManifest?.revision !== 'stage02-phase2b-shipping-possession') throw new Error('Stage02 Phase2B Worker manifest invalid')
const stage02Phase2BBlobSha = (value) => {
