...
if (!original.includes(o1Anchor) || !original.includes(oldBlock)) throw new Error('1906A safe-payment/catalog-gender/order-history/catalog-integrity layer anchors not found')
