...
check(app.includes("!['list', 'zammler'].includes(orderPanel)"), 'CLIENT-ZAMMLER-E: ZAMMLER panel must load its dedicated order list')
...
check(table.includes("По текущим фильтрам ЗАММЛЕР"), 'CLIENT-ZAMMLER-E: ZAMMLER summary missing')
