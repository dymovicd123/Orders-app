...
expect(returnSection.includes('Принять товар'), 'return history delayed receipt action missing')
...
expect(exchangeSection.includes('Принять товар'), 'exchange history delayed receipt action missing')
