...
check(workshopExchange.includes("order.pricing_mode === 'itemized_v1' && exactWorkshopItem") && workshopExchange.includes("? Number(exactWorkshopItem.unitPrice)"), 'H9B Workshop entry does not seed the exact historical sold price')
