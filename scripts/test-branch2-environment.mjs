...
check(wrangler.includes('"database_id": "40065052-854e-44b8-bcd5-251bdd488301"'), 'Branch2 D1 ID drifted')
check(!wrangler.includes('orders_db_prod'), 'Primary D1 binding leaked into Branch2')
check(!wrangler.includes('17e68a41-1d58-4a36-8a63-47c3e32443c4'), 'Primary D1 ID leaked into Branch2')
...
console.log('BRANCH2 ENVIRONMENT SAFETY PASSED — isolated Worker/D1 identity, title marker and stored-password fallback guard preserved')
