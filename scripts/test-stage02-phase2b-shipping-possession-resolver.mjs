...
try {
  ...
  check(shippingClient.includes('askStockResolution') && shippingClient.includes('Да, передаю клиенту') && shippingClient.includes('не пересчёт всего остатка'), 'Phase2B human possession resolver wording is missing')
