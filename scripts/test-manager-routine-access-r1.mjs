...
check(projection.includes("canShip: mutableWorkingOrder && !hasCommittedDownstreamOperation && !sent && !workshopPending"), 'Ordinary send eligibility missing from shared operational projection')
