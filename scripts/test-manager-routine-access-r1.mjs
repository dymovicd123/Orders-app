...
check(projection.includes("canShip: mutableWorkingOrder && !hasActiveReturnOperation && !sent && !workshopPending"), 'Ordinary send eligibility missing from shared operational projection')
