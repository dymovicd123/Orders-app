...
console.log('STAGE03-H6D ITEMIZED EXCHANGE BOUNDARY PASSED — historical legacy assumptions remain documented, H9A supersedes the backend guard deliberately, and both itemized exchange UI entry paths remain fail-closed until H9B')
