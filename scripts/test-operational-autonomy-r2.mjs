...
check(attention.includes('openAttentionLifecycle(item)') && attention.includes('inventory-attention-admin-note">Нужен администратор'), 'unknown identity attention must remain admin-gated')
