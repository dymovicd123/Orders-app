...
try {
  ...
  check(overview.includes('Подтвердить {row.physical}'), 'One-tap confirm action is missing')
  check(overview.includes('Указать другое количество'), 'Mismatch action is missing')
