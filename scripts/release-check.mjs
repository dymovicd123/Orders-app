...
try {
  ...
  run('Catalog resolver R8.1A safe-product-correction tests', process.execPath, [path.join(root, 'scripts/test-catalog-resolver-r8-1a-safe-product-correction.mjs')])
  run('Catalog resolver R8.1B typo-safety tests', process.execPath, [path.join(root, 'scripts/test-catalog-resolver-r8-1b-typo-safety.mjs')])
  ...
  run('Stage02 Phase2C early handover possession resolver', process.execPath, [path.join(root, 'scripts/test-stage02-phase2c-early-handover-possession-resolver.mjs')])
  ...
  run('Stage03-H8E itemized content editor', process.execPath, [path.join(root, 'scripts/test-stage03-h8e-itemized-content-editor.mjs')])
  run('Stage03-H8F direct itemized editor', process.execPath, [path.join(root, 'scripts/test-stage03-h8f-direct-itemized-editor.mjs')])
  run('Stage03-H8G direct Create price', process.execPath, [path.join(root, 'scripts/test-stage03-h8g-direct-create-price.mjs')])
