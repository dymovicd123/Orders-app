...
check(dashboardSection.includes('selectedWorkshopOrder.managerName'), 'Workshop order detail must show manager')
check(dashboardSection.includes('selectedWorkshopOrder.dueDate'), 'Workshop order detail must show deadline')
