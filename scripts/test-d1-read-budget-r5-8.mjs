...
try {
  ...
  check(finance.includes('Array.from(rawPaymentOperationRows.reduce((groups: Map<string, any>, row: any) => {'), 'R5.8 payment-by-day must derive grouped raw methods from payment operations inside Finance scope')
