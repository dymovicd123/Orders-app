...
check(app.includes('aria-label="Разделы ЗАММЛЕР"'), 'CLIENT-ZAMMLER-G: dedicated ZAMMLER sub-navigation missing')
check(app.includes("zammlerView === 'create' ? 'is-active' : ''") && app.includes("zammlerView === 'list' ? 'is-active' : ''"), 'CLIENT-ZAMMLER-G: ZAMMLER sub-tabs do not expose active state')
