...
check(catalog.includes('использованную идентичность сервер не перепишет') && backend.includes('catalogVariantHasOperationalUsage'), 'historical identity protection is not explained/preserved')
