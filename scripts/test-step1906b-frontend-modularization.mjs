...
const root = process.cwd()
const stage02Phase2BFrontendManifest = JSON.parse(fs.readFileSync(path.join(root, 'scripts/stage02-phase2b-shipping-possession-frontend-manifest.json'), 'utf8'))
if (stage02Phase2BFrontendManifest?.version !== 1 || stage02Phase2BFrontendManifest?.revision !== 'stage02-phase2b-shipping-possession') throw new Error('Stage02 Phase2B frontend manifest invalid')
